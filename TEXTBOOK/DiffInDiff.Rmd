...
knitr::include_graphics( "FIGURE/Diff in Diff/Picture1.1.png" )
```
...
knitr::include_graphics( "FIGURE/Diff in Diff/Picture3.1.png" )
```
...
knitr::include_graphics( "FIGURE/Diff in Diff/Housing.png" )
```
...
knitr::include_graphics( "FIGURE/Diff in Diff/Minimum Wage.png" )
```
...
```{r, echo=T}
data = read.csv("FIGURE/Diff in Diff/njmin/DID_Example.csv")
```
