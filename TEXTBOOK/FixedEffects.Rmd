...
Anoter way to look at the data is by demeaning our observations. De-meaning means to substract the mean from each variable. In this case, we are interested in demeaning by group, so that the values of x and y are centered around each group mean. You can observe the process in table \@ref(fig:f5). 
