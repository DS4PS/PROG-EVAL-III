...
```{r doppel, fig.cap="Doppelgänger", out.width='80%', echo=F }
...
In very simple terms, we are looking for **doppelgänger** as the ones in the picture above. A [doppelgänger](https://en.wikipedia.org/wiki/Doppelg%C3%A4nger) are two individuals that look identical even if they are not genetically related!
