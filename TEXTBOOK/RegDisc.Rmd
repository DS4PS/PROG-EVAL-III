...
knitr::include_graphics( "O:/Users/ffusi/Jesse/RegDisc/Picture1.png" )
```
...
knitr::include_graphics( "O:/Users/ffusi/Jesse/RegDisc/Picture2.png" )
```

We expect a positive effect of the scholarship, such that more students in low income families (treatment group) will enroll into college than usual. 

```{r rdfigure3, fig.cap="Treatment effect", out.width='60%', echo=F }
knitr::include_graphics( "O:/Users/ffusi/Jesse/RegDisc/Picture3.png" )
```

The scope of a regression discontinuity model is to assess whether or not we observe a treatment effect. The treatment effect is the difference in the outcome variable between units just above and just below the cutoff point.
...
knitr::include_graphics( "O:/Users/ffusi/Jesse/RegDisc/Picture4.png" )
```
...
<br>
2. $\beta_2$ represents the relationship between the outcome variable and the rating variable. 

## The counterfactual 

The counterfactual is *what it would have occured to Y, had the policy intervention not happened*. In our previous regression discontinuity model, the counterfactual is the students' likelihood to enroll, if they had not received the scholarship.

```{r counterfactual, fig.cap="Counterfactual", out.width='60%', echo=F }
knitr::include_graphics( "O:/Users/ffusi/Jesse/RegDisc/Picture5.png" )
```

If we take our equation \@ref(eq:RD), the counterfactual is obtained by assuming that the intervetion has not occurend (Treatment = 0), so that Y is only predicted by its relationship with rating variable: 
...
knitr::include_graphics( "O:/Users/ffusi/Jesse/RegDisc/Attendance.jpg" )
```
...
points( Attendance_c[Attendance_c<0], predfit2[Attendance_c<0]+rnorm(500,0,5), col=counterfactual, lwd=2, pch = 19, cex = 2 )
...
```{r repstudy, fig.cap="Source: [Washington Post, 2016](https://www.washingtonpost.com/news/national/wp/2016/12/23/nine-charts-that-show-how-white-women-are-drinking-themselves-to-death/?noredirect=on&utm_term=.775639c3d5fe)", out.width='80%', echo=F }
knitr::include_graphics( "O:/Users/ffusi/Jesse/RegDisc/Alcohol.png" )
```
...
```{r, echo = F}
setwd("O:/Users/ffusi/Jesse/RegDisc")
data = read.csv("RegDisc2.csv")
```
